...
class ReconstructiveSubNetwork(nn.Module):
    # def __init__(self,in_channels=3, base_width=128):
        # super(ReconstructiveSubNetwork, self).__init__()
        # self.encoder = EncoderReconstructive(in_channels, base_width)
        # self.decoder_rec = DecoderReconstructive(base_width, out_channels=3)
        # self.decoder_sod = DecoderSalient(base_width, out_channels=2)

    # def forward(self, x):
        # b5 = self.encoder(x)
        # output_rec = self.decoder_rec(b5)
        # output_sod = self.decoder_sod(b5)
        # return output_rec, output_sod
...
class DecoderSalient(nn.Module):
    def __init__(self, base_width, out_channels=2):
        super(DecoderSalient, self).__init__()
